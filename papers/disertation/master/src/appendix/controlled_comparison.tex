...
For the sake of comparison, we tried implementing the controlled gate by manually building the matrix via Kronecker-product construction and applying it as a single \texttt{UnitaryGate}.
To our surprise, this sped up the simulation quite a bit.
