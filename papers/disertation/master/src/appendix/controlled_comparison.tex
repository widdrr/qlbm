...
For the sake of comparison, we tried implementing the controlled gate by manually building the matrix via Kronecker-product construction and apply it as a single \texttt{UnitaryGate}.
