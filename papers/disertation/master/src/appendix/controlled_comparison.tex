...
After implementing boundary conditions, I ran into very slow simulations that were impractical to run.
Analyzing the runtime, I managed to isolate the bottleneck to the controlled unitaries in the collision step.
On a whim I decided to try implementing the controlled gate by manually building the matrix via Kronecker-product construction and apply it as a single \texttt{UnitaryGate}.
To my surprise, this sped up simulation quite a bit.
