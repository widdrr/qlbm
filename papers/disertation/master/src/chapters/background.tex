...
\label{fig:disc}
\end{figure}
\todo{REVISION: center Figure 2.1 properly}
...
\todo{REVISION: finish section 2.2 completely}
...
\todo{REVISION: move section 2.5 (LCU) into the quantum computing section as an "advanced" topic}
