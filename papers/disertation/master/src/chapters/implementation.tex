...
\paragraph*{Collision}
The BGK collision operator from Equation~\ref{eq:bgk-collision} can be implemented as a diagonal matrix $M$ of size $2^{m+n} \times 2^{m+n}$, where $m$ is the number of lattice qubits and $n$ is the number of link qubits.
