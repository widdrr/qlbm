...
Despite our considerable investigation, we have not yet identified the exact mechanism behind the error.
Based on empirical observations, our current hypothesis is that it is caused by complex, spatially varying velocity fields. 
...
This shows another relatively high error compared to the simple scenarios. Interestingly, the RMSE starts decreasing once the velocity field is removed.
This lends credence to the hypothesis for complex velocity fields.
