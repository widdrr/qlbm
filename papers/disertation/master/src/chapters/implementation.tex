...
\todo{REVISION: remove "minor numerical differences" — what does that even mean? Also do NOT present the initialization trick as an improvement — in practice it's probably worse}
...
\todo{REVISION: merge boundary conditions into the initial algorithm presentation — don't keep it as a separate section}
...
\todo{REVISION: add code snippets for essential parts of the implementation}
