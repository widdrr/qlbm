...
\begin{enumerate}
    ...
    \item \textbf{Computation Macroscopic Quantities}: Recover the macroscopic distribution from the final state.
\end{enumerate}
...
First of all, in a quantum circuit we are usually interested in the \emph{circuit depth}: the number of sequential of quantum gates used to implement the circuit as a function of the size of the input.
...
\paragraph*{Macroscopic Quantities Computation} is linear with respect to number of links: $\mathcal{O}(N)$; as previously described.
