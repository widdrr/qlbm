...
Investigating and rigorously explaining the higher RMSE observed for complex advection fields is at the forefront.
On the functional side, the simulator could be extended beyond the Advection-Diffusion equation, towards simulating Navier-Stokes flows.
Another interesting avenue is support for non-stochastic boundary conditions: designing a method to encode quantity gain and loss within the quantum state.
